...
"""
 Python for Data Science - Load ‘Student Performance dataset’ into one of the data structures
(NumPy or Pandas). Perform data pre-processing on this dataset. Create dataframes, perform
